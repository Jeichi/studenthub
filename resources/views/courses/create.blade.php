                ...
                <form method="post" action="{{ route('courses.store') }}">
                    ...
                    <div class="px-4 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full" id="level" type="text" autocomplete="name" />
                            @error('name')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
